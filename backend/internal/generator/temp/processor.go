...
type TextProcessor interface {
    RenderText(img draw.Image, data *card.CardData, bounds *layout.TextBounds) error
}
...
func (tp *textProcessor) RenderText(img draw.Image, data *card.CardData, bounds *layout.TextBounds) error {
...
func (tp *textProcessor) renderTitle(data *card.CardData, bounds *layout.TextBounds) error {
    // Create a Card interface implementation from CardData
...
func (tp *textProcessor) renderEffect(data *card.CardData, bounds *layout.TextBounds) error {
...
func (tp *textProcessor) renderStats(data *card.CardData, bounds *layout.TextBounds) error {
    if bounds.Stats == nil {
...
// cardImpl implements the card.Card interface for CardData
